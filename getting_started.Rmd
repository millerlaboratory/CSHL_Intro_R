...
Download this file: "https://github.com/millerlaboratory/CSHL_Intro_R/blob/80750baf316b4854d1fbd98d8249ddbb2ff8595c/color_srgb.csv" (Should already be downloaded)
...
**Install BPCells** (may not be necessary)
```{r}
install.packages('BPCells', repos = c('https://bnprks.r-universe.dev', 'https://cloud.r-project.org'))
```

If this doesn't work, you may need to first install the hdf5 library on your computer:
In your terminal (on MacOS computers)

AGAIN, DON'T DO THIS IF BPCells installs
...
then run `remotes::install_github("bnprks/BPCells/r")`
